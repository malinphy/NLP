...
# pooled_output, sequence_output = bert_layer([ input_mask, input_type_ids,input_word_ids,])
...
preds_start, preds_end = model.predict(
            [
            (pad_ids_test[0:6]), 
            (pad_attention_mask_test[0:6]), 
            (pad_type_ids_test[0:6])
            ])
